...
using MeihanaUI.Models.About;
using MeihanaUI.Core.Helper;

namespace MeihanaUI.ViewModels.About
{
    /// <summary>
    ...
    public class AboutUsViewModel : ViewModelBase
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:MeihanaUI.ViewModels.About.AboutUsViewModel"/> class.
        /// </summary>
